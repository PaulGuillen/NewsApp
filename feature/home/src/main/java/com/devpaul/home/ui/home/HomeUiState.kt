...
data class HomeUiState(
    ...
    val season: ResultState<SeasonEntity> = ResultState.Loading,
    val section: ResultState<SectionEntity> = ResultState.Loading,
    val holidayAlert: ResultState<com.devpaul.home.domain.entity.HolidayAlertEntity> = ResultState.Loading,
    val sunatExchangeRate: ResultState<com.devpaul.home.domain.entity.SunatExchangeRateEntity> = ResultState.Loading,
