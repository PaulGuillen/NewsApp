...
class GeneralSkeleton : SkeletonStrategy {
    @Composable
    override fun Render(modifier: Modifier) {
        GeneralSkeletonContent(modifier)
    }
}

@Composable
fun GeneralSkeletonContent(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        // Simulamos 3 tarjetas de emergencia
        repeat(3) {
            Column(
                modifier = Modifier
                    .fillMaxWidth()
...
@Composable
fun DetailSkeletonPreview() {
    GeneralSkeletonContent()
}